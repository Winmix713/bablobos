...
import { FigmaConnectionProvider } from "@/components/core/figma-connection-provider"
import { FigmaStatusToast } from "@/components/core/figma-status-toast"
import Header from "@/components/ui/header"
import FigmaConverter from "@/components/core/figma-converter"
import { PerformanceMonitorPanel } from "@/components/ui/performance-monitor"
          ...
          <main className="container mx-auto px-4 py-8 space-y-8">
            ...
            {showErrorTesting && (
              <EnhancedErrorBoundary
                ...
                fallback={
                  <div className="text-center p-8 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-lg">
                    <h3 className="text-lg font-semibold text-red-900 dark:text-red-100 mb-2">🎯 Error Boundary Test Successful!</h3>
